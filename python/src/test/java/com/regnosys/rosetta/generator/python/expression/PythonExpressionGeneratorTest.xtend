...
class PythonExpressionGeneratorTest {
    ...
    def void shouldGenerateNumberLiteralCondition(){
    	 ...
    	 val python = '''type Test1: <"Test rosetta number literal  condition.">
	        ...
	        class Test1(BaseDataClass):
	            """
	            Test rosetta number literal  condition.
	            """
    ...
    def void shouldGenerateintLiteralCondition(){
    	val python = '''
    	  	type Test1: <"Test rosetta int literal  condition.">
	       ...
	       class Test1(BaseDataClass):
	           """
	           Test rosetta int literal  condition.
	           """
    ...
    def void shouldGenerateStringLiteralCondition(){
    	val python = '''type Test1: <"Test rosetta string literal  condition.">
	       ...
	       class Test1(BaseDataClass):
	           """
	           Test rosetta string literal  condition.
	           """
	           field1: Optional[str] = Field(None, description="Test string field 1")
	           """
	           Test string field 1
    	...
    	val python = '''type A: <"Test type">
	        ...
	        class Test(BaseDataClass):
	            ...
	            def condition_0_TestCond(self):
	                ...
	                item = self
	                def _then_fn0():
	                    return check_one_of(self, _resolve_rosetta_attr(_resolve_rosetta_attr(self, "aValue"), "field1"))
    ...
    def void shouldGenerateSortCondition(){
    	 val python = '''type A: <"Test type">
            ...
            type Test: <"Test sort operation condition">
            aValue A (1..1) <"Test A type aValue">
            condition TestCond: <"Test condition">
                if aValue->field1 exists 
	        ...
	        class A(BaseDataClass):
	            ...
	            Test int field 1
	            """
	            field2: Optional[int] = Field(None, description="Test int field 2")
	            """
	            Test int field 2
	            """
     		'''
    ...
    def void shouldGenerateLastCondition(){
    	val python = '''type A: <"Test type">
            field1 int (0..*) <"Test int field 1">
                field2 int (0..1) <"Test int field 2">
            type Test: <"Test last operation condition">
            aValue A (1..1) <"Test A type aValue">
            condition TestCond: <"Test condition">
                if aValue->field1 exists 
    ...
    def void shouldGenerateSumCondition(){
    	val python = '''
  			type A: <"Test type">
  			            field1 int (0..*) <"Test int field 1">
  			                field2 int (0..1) <"Test int field 2">
  			            type Test: <"Test sum operation condition">
  			            aValue A (1..1) <"Test A type aValue">
  			            condition TestCond: <"Test condition">
  			                if aValue->field1 exists 
    	 ...
    	 val python = '''type A: <"Test type">
	        ...
	        class Test(BaseDataClass):
	            ...
	            def condition_0_TestCond(self):
	                ...
	                """
	                item = self
	                return (lambda item: _resolve_rosetta_attr(_resolve_rosetta_attr(item, "aValue"), "field2")[0])(rosetta_filter(item, lambda item: _resolve_rosetta_attr(_resolve_rosetta_attr(item, "aValue"), "field1")))
	        '''
	        val expectedClassA='''
	        class A(BaseDataClass):
	            """
    ...
    def void shouldGenerateBinJoinCondition(){
    	val python = '''
	        ...
	        class Test(BaseDataClass):
	            """
	            Test join binary expression condition
	            """
	            field1: str = Field(..., description="Test string field1")
	            """
	            Test string field1
